...
scanf("%d",&n);
	...
	if(n==0){
		...
		printf("\nTime taken to sort data in ascending of descendingly sorted data= %f",total_time);
			...
			heap_create(arr,size);
			int max=heap_extract_max(arr,size);
